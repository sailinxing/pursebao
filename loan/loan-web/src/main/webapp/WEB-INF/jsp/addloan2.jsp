...
<!--头部 end -->
		...
		<%--<div class="main clear mart50"  style="width: 970px;margin: 0 auto">
			...
			<div class="main-con">
				...
				<p class="jkstep" style="20px 0 0 84px;margin-top:10px;padding-left: 66px;">
				...
				-->
		<form action="${pageContext.request.contextPath}/loan/addloan" method="get" id="submitAll" >
					<%--<form action="${pageContext.request.contextPath}/loan/addloan" method="post" id="submitAll" onsubmit="return validateParams()" >--%>
				<%--<input type="hidden"  name="lid"  id="" value='' />--%>
				<h2 class="h2title01">
					借款申请表
				</h2>
				<h3 class="h3title">
					...
					<dl class="clear mart20">
						...
						<dd class="left dd02" style="hight:100px;width:395px">
						   <div style="float:left;" >
							...
							<div  id="gdsy" style="display:;float:left;width:290px;"
									 >
				...
				<%--	<dl class="clear mart20">
					...
					<dl class="clear mart20">
						...
						<dd class="left dd04">
							...
							<%--<span><input id="qt" name="isOther" type="checkbox" value="1"   />其他
							</span>--%>
						</dd>
					</dl>
					<dl class="clear mart20">
