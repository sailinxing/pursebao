                ...
                var active = {
                    notice: function(){
                        ...
                        layer.open({
                            ...
                            ,content: '<div style="padding: 50px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">您需要还款的本金及利息共${repaymoney}元？确定支付么？</div>'
                            ,success: function(layero){
                                var btn = layero.find('.layui-layer-btn');
                                btn.find('.layui-layer-btn0').attr({
                                    href: '${pageContext.request.contextPath}/loan/repay?lid=${loan.lid}&repaymoney=${repaymoney}'
                                    ,target: '_blank'
                                });
                            }
                        });
			...
			<div class="main-con">
					...
					<div class=" mar45 c333 jkxx">
                        ...
                        <dl class="clear mart20">
                            ...
                            <dd class="left dd02">
                                 <span>
                                      ${loan.loanOnline==1?" 未放款":loan.loanGettimeStr}
                                 </span>
                            </dd>
                        </dl>
                        <dl class="clear mart20">
                            ...
                            <dd class="left dd02">
                               <span>
                                   ${loan.loanOnline==1?" 未放款":loan.loanOvertimeStr}
                               </span>
                            </dd>
                        </dl>
                        <dl class="clear mart20">
                            ...
                            <dd class="left dd02" style="hight:100px;width:395px">
                                ...
                                <div  id="gdsy" style="float:left;width:290px;"	>
									<span>
									${loan.loanLimittime/30}月
                                    </span>
                                </div>
                            </dd>
                        </dl>
                        ...
                        <c:if test="${empty message}">
                                       <c:if test="${loan.repaymentStatus==1}">
                                               <button data-method="notice" class="layui-btn">立即还款</button>
                                       </c:if>
                        </c:if>
                        <c:if test="${!empty message}">
                                    <button class="layui-btn layui-btn-warm">${message}</button>
                        </c:if>
                              </div>
                        </div>
                    </div>
