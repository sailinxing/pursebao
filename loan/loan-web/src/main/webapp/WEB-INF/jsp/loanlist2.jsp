...
<link type="image/x-icon" rel="icon"  href="${pageContext.request.contextPath}/template/images/favicon.ico" />
    ...
    <div class="header clear">
        <div class="headerInner clear">
            ...
            <ul class="menu clear">
                ...
                <li class="cur"><a href="/addLoanPage_add.html">我要借款</a></li>
                <li ><a href="/invest_queryLoanPlan.html?page=1">项目列表</a></li>
    ...
    <div class="projectBox projectList">
        <div class="projectCon clear">
            <div class="content plainPart left" id="plainPart0" style="display:block">
                <div>
                    <c:forEach items="${loanPagebean.pageData}" var="loan" varStatus="vs">
            		...
            		<div class="pagingWrap">
						...
						<div class="page-box" style="line-height:23px">
                            ...
                            <c:if test="${loanPageBean.totalCount!=0}">
                                           <c:if test="${loanPagebean.currentPage==1}">
                                              <a>上一页</a>
                                            </c:if>
                                            <c:if test="${loanPagebean.currentPage!=1}">
                                              <a href="${pageContext.request.contextPath}/loan/toloanlist?currentPage=${loanPagebean.currentPage-1}">上一页</a>
                                            </c:if>
                                            <c:forEach begin="${loanPagebean.currentPage>4?loanPagebean.currentPage-4:1}" end="${loanPagebean.currentPage+6<loanPagebean.totalPage?loanPagebean.currentPage+6:loanPagebean.totalPage}" var="page">
                                            <c:if test="${page==loanPagebean.currentPage}">
                                             <span class="current">${page}</span>
                                            </c:if>
                                            <c:if test="${page!=loanPagebean.currentPage}">
                                            <a href="${pageContext.request.contextPath}/loan/toloanlist?currentPage=${page}">${page}</a>
                                            </c:if>
                                            </c:forEach>
                                           <c:if test="${loanPagebean.currentPage==loanPagebean.totalPage}">
                                               <a>下一页</a>
                                            </c:if>
                                            <c:if test="${loanPagebean.currentPage!=loanPagebean.totalPage}">
                                              <a href="${pageContext.request.contextPath}/loan/toloanlist?currentPage=${loanPagebean.currentPage+1}">下一页</a>
                                            </c:if>
                                            <c:if test="${loanPagebean.currentPage!=loanPagebean.totalPage}">
                                               <a href="${pageContext.request.contextPath}/loan/toloanlist?currentPage=${loanPagebean.totalPage}">尾页</a>
                                            </c:if>
                                            <c:if test="${loanPagebean.currentPage==loanPagebean.totalPage}">
                                                <a>尾页</a>
                                            </c:if>
                                <span class="page-all">共${loanPagebean.totalPage}页</span>
                            </c:if>
                        </div>
