                ...
                <div class="span12">
                    ...
                    <div class="widget red">
                        <div class="widget-title">
                            <h4><i class="icon-reorder1"></i>客户列表</h4>
                            <span class="tools">
                            ...
                            <table class="table table-bordered table-hover" id="sample_1">
                                ...
                                <c:forEach items="${userlist}" var="user" varStatus="vs">
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="hidden-phone">${user.companyId}</td>
                                        <td class="hidden-phone">${user.accountId}</td>
                                        <td>
                ...
                <div style="margin: 0 auto;">
                    <form id="editForm" method="post" class="form-horizontal" action="">
                        <div class="form-group" style="margin: auto;">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">客户编号</label>
                            <input type="text" class="form-control" name="firstName" placeholder="纯数字" style="margin-left: 20px;" value="${user.uid}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">姓名</label>
                            <input type="text" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.username}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">密码</label>
                            <input type="password" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.password}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">实名</label>
                            <input type="text" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.realname}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">身份证</label>
                            <input type="text" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.idCard}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">支付密码</label>
                            <input type="password" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.payPassword}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">会员</label>
                            <input type="text" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.vip}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">积分</label>
                            <input type="text" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.score}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">实名认证</label>
                            <input type="text" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.namePass}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">邮箱</label>
                            <input type="text" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.email}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">手机</label>
                            <input type="text" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.phone}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">头像</label>
                            <input type="text" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.headImage}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">公司</label>
                            <input type="text" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.companyId}"/>
                        </div>
                        <div class="form-group" style="">
                            <label class="col-lg-3 control-label" style="text-align: right; width: 100px;">账户</label>
                            <input type="text" class="form-control" name="firstName" placeholder="" style="margin-left: 20px" value="${user.accountId}"/>
                        </div><br>
                        <div class="form-group" style="margin: auto">
