            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class="" href="${pageContext.request.contextPath}/investmanage/ordersmanage">投资订单</a></li>
                    </ul>
                </li>
                ...
                <div class="span12">
                    ...
                    <div class="widget red">
                        <div class="widget-title">
                            <h4><i class="icon-reorder1"></i>投资订单列表</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <table class="table table-bordered table-hover" id="sample_1">
                                ...
                                <tr>
                                    ...
                                    <th >投资订单编号</th>
                                    <th >投资人</th>
                                    <th class="hidden-phone">投资金额</th>
                                    <th class="hidden-phone">投资日期</th>
                                    <th class="hidden-phone">投资产品</th>
                                    <th class="hidden-phone">投资人电话</th>
                                ...
                                <c:forEach items="${orderlist}" var="order">
                                    <tr class="odd gradeX">
                                        ...
                                        <td><input type="checkbox" id="Check" name="Check[]" onclick="checkOneAction()" value="${order.oid}"/></td>
                                        <td>${order.oid}</td>
                                        <td>${order.username}</td>
                                        <td class="hidden-phone">${order.investMoney}</td>
                                        <td class="hidden-phone">${order.strInvestDate}</td>
                                        <td class="hidden-phone">${order.pid}</td>
                                        <td class="hidden-phone">${order.phone}</td>
                                            <td class="hidden-phone">${order.orderStatusStr}</td>
                                        <td>
                                            <a class="btn btn-danger" value="${order.oid}" onclick="deleteOneAction('${order.oid}')"><i class="icon-trash "></i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
...
<script type="text/javascript">
    ...
    $('#sample_1').on('click', '#delete', function(){
        ...
        if (result) { // 确定
            ...
            $.post(
                "${pageContext.request.contextPath}/investorder/orderdelete",
                {"ids[]": checkData},
                function (data) {
                    if(data == "success") {
                        window.location.href = "${pageContext.request.contextPath}/investorder/orderlist";
                    }
                },
                "text"
            );
