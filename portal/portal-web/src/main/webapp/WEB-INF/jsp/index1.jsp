...
<div class="article warp">
      ...
      <ul>
        <li>
          <div class="p_con left">
            <h3>
              <i></i>
              <a href="${pageContext.request.contextPath}/project/index/projectdetail/id/476396039977280" target="_blank">供应链ZGXL58055</a>
          ...
          <div class="invest right">
            <p class="surplus_num">剩余可投：<span>115</span>元</p>
            <p class="surplus_hr"><span style="width:99%"></span></p>

            <p class="invest_btn">
              <a href="${pageContext.request.contextPath}/project/index/projectdetail/id/476396039977280" target="_blank" title="立即投资">立即投资</a>                        </p>
          </div>
        </li>
      </ul>
    </div>
      ...
      <ul>
        <li>
          <div class="p_con left">
            <h3>
              <i></i>
              <a href="${pageContext.request.contextPath}/project/tyj/invest/id/7731" target="_blank">体验标</a>
              <a href="javascript:;">
              </a>
            </h3>
            <div class="profit">
          ...
          <div class="invest right">
            <p class="surplus_num">剩余可投：<span>1970000</span>元</p>
            <p class="surplus_hr"><span style="width:2%"></span></p>
            <p class="invest_btn"><a href="${pageContext.request.contextPath}/project/tyj/invest/id/7731" target="_blank" title="立即投资">立即投资</a></p>
          </div>
        </li>
      </ul>
    </div>
  ...
  <div class="product_fixed clearfix">
    ...
    <div class="p_list right">
      <a href="${pageContext.request.contextPath}/project.html" target="_blank" class="more">更多 &gt;</a>
      <ul>
        <li>
          <div class="p_con left">
            <h3>
              <i></i>
              <a href="${pageContext.request.contextPath}/project/index/projectdetail/id/476751279069248" target="_blank">供应链ZGXL64051</a>
              <a href="javascript:void(0);" >
              </a>
            </h3>
            <div class="profit">
          ...
          <div class="invest right">
            <p class="surplus_num">剩余可投：<span>829562</span>元</p>
            <p class="surplus_hr"><span style="width:17%;"></span></p>
            <p class="invest_btn">
              <a href="${pageContext.request.contextPath}/project/index/projectdetail/id/476751279069248" target="_blank" title="立即投资">立即投资</a>                        </p>
          </div>
        </li>
        <li>
          <div class="p_con left">
            <h3>
              <i></i>
              <a href="${pageContext.request.contextPath}/project/index/projectdetail/id/476569121026112" target="_blank">供应链ZGXL07052</a>
              <a href="javascript:void(0);" >
              </a>
            </h3>
            <div class="profit">
          ...
          <div class="invest right">
            <p class="surplus_num">剩余可投：<span>617112</span>元</p>
            <p class="surplus_hr"><span style="width:38%;"></span></p>
            <p class="invest_btn">
              <a href="${pageContext.request.contextPath}/project/index/projectdetail/id/476569121026112" target="_blank" title="立即投资">立即投资</a>                        </p>
          </div>
        </li>
      </ul>
    </div>
