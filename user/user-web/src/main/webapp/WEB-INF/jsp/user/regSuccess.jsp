...
<div class="member clearfix">
    <div class=" regSuc">
        <div class="suc_del">
            <h1>注册完成！</h1>
            <p>欢迎您成为千贷宝第<span>1631610</span>位用户</p>
            <img src="${pageContext.request.contextPath}/picture/reg_suc.png"/>
            <p><a href="${pageContext.request.contextPath}/account/myWallet.do" title="立享新手福利"></a></p>
        </div>
    </div>
</div>
<!--内容区 end-->
<script type="text/javascript" >
    var str1 = "13758193775";
    var _ozprm = "uid99=" + str1;
</script>
<!-- 底部 -->
<div class="footer">
    ...
    <div class="footer_icp warp">
        ...
        <p>
            ...
            <a href="/static/images/icp_img.jpg" target="_blank">京ICP证140409号</a>　|　<a href="http://www.miitbeian.gov.cn/publish/query/indexFirst.action" target="_blank">京ICP备17042235号</a>　|　机构信用代码证 91110107MA00EU339B
        </p>
        <p>
