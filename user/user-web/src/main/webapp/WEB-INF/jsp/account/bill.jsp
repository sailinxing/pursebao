...
<div class="member clearfix">
    ...
    <div class="left_nav">
        ...
        <dl>
            ...
            <dd><a href="${pageContext.request.contextPath}/account/bill.do" class='on'>账单</a></dd>
        </dl>
        <dl>
    ...
    <!--左导航 end-->
    <!--右内容区-->
    <div class="right_con member_account">
        <div class="section">
            <div class="crumbs">
                <span>我的账户</span>&gt;<span>资金管理</span>&gt;<span>账单</span>
            </div>
        </div>
        <div class="section clearfix">
            <h2>
                ...
                <div class="styled-select">
                    <select name="">
                        <option value="1" selected=selected>2018/02/01-2018/02/28</option>
                        <option value="2" >2018/01/01-2018/01/31</option>
                        <option value="3" >2017/12/01-2017/12/31</option>
                    </select>
            ...
            <div class="list1">
                <h3>本月已到账收益</h3>
                <div id="account_charts"></div>
                <div class="right_text">
                    <ul>
                        <li>本月赚取利息金额： 0.00元</li>
                        <li>本月返利收益金额： 0.00元</li>
                        <li>本月使用红包金额： 0.00元</li>
                        <li>本月加息券收益金额： 0.00元</li>
                        <li>本月体验金收益金额： 0.00元</li>
                        <li>本月返现券收益金额： 0.00元</li>
                    </ul>
                </div>
            </div>
            <div class="list2">
                <h3>本月累计投资金额</h3>
                <div id="account_charts2"></div>
                <div class="right_text">
                    <ul>
                        <!--<li>活钱宝： 0.00元</li>-->
                        <li>固收项目： 0.00元</li>
...
<script type="text/javascript">
    var account_charts = echarts.init(document.getElementById('account_charts'));
    var account_charts2 = echarts.init(document.getElementById('account_charts2'));
    var option = {
        tooltip: {
            trigger: 'item',
        ...
        series: [
            {
                ...
                data: [
                    {value: "0.00", name: '赚取利息'},
                    {value: "0.00", name: '返利收益'},
                    {value: "0.00", name: '使用红包'},
                    {value: "0.00", name: '加息券收益'},
                    {value: "0.00", name: '返现券收益'},
                    {value: "0.00", name: '体验金收益'}
                ]
            }
        ],
        color: ["#5db0ff", "#ff706f", "#5fd4ba", "#ba8cd5", "#ffb109", "#FE9100"]
    };


    var seriesData = [{value: "0.00", name: '固收项目'}];
    if ("0" > 0) {
        seriesData.push({value: "0.00", name: '散标项目'});
    }

    if ("0" > 0) {
        seriesData.push({value: "0.00", name: '债权转让'});
    }
    ...
    account_charts.setOption(option);
    account_charts2.setOption(option2);
    //刷新数据
    $(".styled-select select").change(function () {
        var m = $(this).val();
        window.location.href = '/account/capital/bill/changeTime/' + m + '.html';
    });
</script>
<!-- 底部 -->
<div class="footer">
