...
<div class="member clearfix">
    ...
    <div class="left_nav">
        ...
        <dl>
            ...
            <dd><a href="${pageContext.request.contextPath}/account/payment.do" class='on'>回款明细</a></dd>
    ...
    <div class="right_con return_money">
        <div class="section">
            <div class="crumbs">
                <span>我的账户</span>&gt;<span>资金管理</span>&gt;<span>回款明细</span>
                <i class="help">
                    <span class="tips_text tips_text2 blue"><em></em>回款明细仅包含固收项目</span>
                </i>
            </div>
        </div>
        <div class="section clearfix min-height">
            <div class="mum">
                <ul>
                    <li>
                        <h5>总回款本金</h5>
                        <p><span class="orange">0.00</span>元</p>
                    </li>
                    <li>
                        <h5>总回款利息</h5>
                        <p><span class="orange">0.00</span>元</p>
            ...
            <h4>
                本月回款本金（元）：<span class="orange">0.00</span>&nbsp;&nbsp;本月回款利息（元）：<span class="orange">0.00</span>
            </h4>
...
<script>
    $(function () {
        laydate.render({
            elem: '#startDate'
            , min: "2017-09-1 00:00:00"
            , max: "2019-03-31 23:59:59"
        });
        laydate.render({
            elem: '#endDate'
            , min: "2017-09-1 00:00:00"
    ...
    function nextPage(goPage) {
        ...
        $.ajax({
            url: "/account/capital/paymentajax.html",
            data: {goPage: goPage, startDate: startDate, endDate: endDate},
            async: false,
            type: "post",
            dataType: "html",
