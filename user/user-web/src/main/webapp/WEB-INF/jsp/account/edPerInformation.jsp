...
<div class="member clearfix">
    ...
    <div class="right_con">
        ...
        <div class="section clearfix personal_information">
            <form action="${pageContext.request.contextPath}/user/updatePerInformation.do" method="post">
            <div class="success_tips">保存成功！<em class="time">3</em>S后自动跳转</div>
            <h3><span>基本信息</span></h3>
            <ul class="pi1">
                <li><span></span><input type="hidden" name="uid" style="width: 200px;height: 25px" value="${sessionUserAccount.uid}"/></li>
                <li><span>用户名：</span><input type="text" name="username" style="width: 200px;height: 25px" value="${sessionUserAccount.username}"/></li>
                <li><span>真实姓名：</span><input type="text" name="realname" style="width: 200px;height: 25px" value="${sessionUserAccount.realname}"/></li>
                <li><span>身份证号：</span><input type="text" name="idCard" style="width: 200px;height: 25px" value="${sessionUserAccount.idCard}"/></li>
                <li><span>邮箱：</span><input type="text" name="email" style="width: 200px;height: 25px" value="${sessionUserAccount.email}"/></li>
                <%--<li><span>联系地址：</span><input type="text" name="" style="width: 200px;height: 25px" value=""/></li>--%>
            </ul>

            <ul class="pi2">
                <li><span></span><button class="btn" type="submit">保存</button></li>
