...
<div class="member clearfix">
    ...
    <div class="right_con">
        <div class="section">
            <div class="crumbs">
                <span>我的账户</span>&gt;<span>账户与安全</span>
            </div>
        </div>
        <div class="section clearfix account_security">
            <table>
                <tr>
                    <th width="18%">登录密码</th>
                    <td width="70%">定期更换密码让您的账户更安全</td>
                    <td><a href="${pageContext.request.contextPath}/user/setLoginPwd.do" class="as_btn">修改</a></td>
                </tr>
            </table>
            <table>
                <tr>
                    <th width="18%">手机号</th>
                    <td width="70%">已认证手机137****3775</td>
                    <td><a href="/account/security/updatephone/phone/137****3775.html" class="as_btn">修改</a></td>
                </tr>
            </table>
            <table>
                <tr>
                    <th width="18%">我的银行卡</th>
                    <td width="70%">
                        银行卡用于资金的充值和提现，请尽快设置您的银行卡
                    </td>
                    <td>
                        <a href="/account/recharge/index.html" class="as_btn">绑卡</a>
                    </td>
                </tr>
            </table>
            <table>
                <tr>
                    <th width="18%">支付密码</th>
                    <td width="70%">
                        为了保障您的账户资金安全，请尽快设置您的资金密码
                    </td>
                    <td>
                        <a href="${pageContext.request.contextPath}/user/setPayPwd.do" class="as_btn">
                            设置
                        </a>
                    </td>
                </tr>
            ...
            <table>
                <tr>
                    <th width="18%">风险测评</th>
                    <td width="70%">
                        我们会根据您的风险承受能力和投资偏好，为您提供个性化理财服务。
                    </td>
                    <td><a href="https://m.jinlianchu.cn/account/security/measurement.html?source=2&token=D9E0FDA1BEF2A5AAD811A42AFEDC4A04,1654014" class="as_btn">我要测评</a></td>
                </tr>
            </table>
        </div>
    </div>
