...
<div class="member clearfix">
    ...
    <div class="right_con reCharge">
        <div class="section">
            <div class="crumbs">
                <span>我的账户</span>&gt;<span>充值认证</span>
            </div>
        </div>
        <div class="section section_right">
            <div class="rz_form">
                <form action="${pageContext.request.contextPath}/account/rechargeSuccess.do" method="post">
                    <table>
                       <%-- <tr>
                            <td>真实姓名：</td>
                            <td>
                                <input type="text" name="realName" placeholder="请输入您本人的真实姓名" value="" id="firstChargeName" class="ipt1" />
                            </td>
                        </tr>
                        <tr>
                            <td>身份证号：</td>
                            <td>
                                <input type="text" name="idNo" placeholder="请输入您本人的身份证号" value="" id="firstChargeId" class="ipt1" />
                            </td>
                        </tr>--%>
                       ...
                       <%-- <tr>
                            <td>充值银行卡：</td>
                            <td>
                                <input type="text" name="bankCard" placeholder="请输入您本人的银行卡号" value="" id="firstChargeCardnum" class="ipt1" />
                                <label class="gray" id="bankInfo">该卡是您以后快捷充值和提现的唯一银行卡</label>
                            </td>
                        </tr>--%>
                           <tr>
                               <td>金额(元)：</td>
                               <td>
                                   <input type="text" name="accountAmount" placeholder="请输入" id="amount" class="ipt1"/>
                               </td>
                           </tr>
                           <tr>
                               <td></td>
                               <td>
                                   <button id="next_btn" type="submit">确认充值</button>
                    ...
                    class="next_btn disabled"

                    <input type="hidden" name="bankName" value=""/>
                    <input type="hidden" name="singleLimit" value="0"/>
                    <input type="hidden" name="dayLimit" value="0"/>
                    <input type="hidden" name="tipflag" value=""/>
