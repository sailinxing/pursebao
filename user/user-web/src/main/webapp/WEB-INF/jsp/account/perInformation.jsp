...
<div class="member clearfix">
    ...
    <div class="left_nav">
        ...
        <dl>
            ...
            <dd><a href="${pageContext.request.contextPath}/account/perInformation.do" class="on">个人信息</a></dd>
    ...
    <div class="right_con">
        <div class="section">
            <div class="crumbs">
                <a href="/">我的账户</a>&gt;<span>个人信息</span>
            </div>
        </div>
        <div class="section clearfix personal_information">
            <div class="success_tips">保存成功！<em class="time">3</em>S后自动跳转</div>
            <h3><span>基本信息</span></h3>
            <ul class="pi1">
                <li><span></span><input type="hidden" name="uid" readonly="readonly" style="width: 200px;height: 25px" value="${sessionUserAccount.uid}"/></li>
                <li><span>用户名：</span><input type="text" name="username" readonly="readonly" style="width: 200px;height: 25px" value="${sessionUserAccount.username}"/></li>
                <li><span>真实姓名：</span><input type="text" name="realname" readonly="readonly" style="width: 200px;height: 25px" value="${sessionUserAccount.realname}"/></li>
                <li><span>身份证号：</span><input type="text" name="id_card" readonly="readonly" style="width: 200px;height: 25px" value="${sessionUserAccount.idCard}"/></li>
                <li><span>邮箱：</span><input type="text" name="email" readonly="readonly" style="width: 200px;height: 25px" value="${sessionUserAccount.email}"/></li>
               <%-- <li><span>联系地址：</span><input type="text" name="" readonly="readonly" style="width: 200px;height: 25px" value=""/></li>--%>
            </ul>

            <ul class="pi2">
                <li><span></span><a href="${pageContext.request.contextPath}/user/edPerInformation.do" class="btn">编辑</a></li>
                <%--<li><span></span><a href="javascript:void(0);" class="btn disabled" id="change_address_btn">编辑</a></li>--%>
            </ul>
        </div>
    </div>
    <!--右内容区 end-->
...
<div class="right_con">
    ...
    <div class="section clearfix personal_information">
        ...
        <h3><span>基本信息</span></h3>
        <ul class="pi1">
            <li><span>用户名：</span>jlc13758193775</li>
            <li><span>真实姓名：</span></li>
            <li><span>身份证号：</span></li>
        </ul>
        <h3><span>联系信息</span></h3>
        <ul class="pi2">
            <li><span>联系地址：</span><input type="text" name="" id="address" class="ipt1" value="" maxlength="50" placeholder="请输入联系地址" /></li>
            <li><span></span><a href="javascript:;" class="btn disabled" id="change_address_btn">保存</a></li>
        </ul>
    </div>
</div>
<!--右内容区 end-->
...
<script type="text/javascript">
    ...
    $(function () {
        checkInputSubmit('change_address_btn');
        $("#change_address_btn").click(function () {
            if (!$(this).hasClass("disabled")) {
                var address = $("#address").val();
                if (address == "") {
                    $("#address").focus();
                    layer.msg('联系地址不能为空', {time: 3000});
                    return false;
                }
                $.ajax({
                    url: '/account/information/index.html',
                    data: {useAdr: address},
                    type: 'post',
                    dataType: 'json',
                    async: false,
                    success: function (msg) {
                        if (msg.code == 0) {
                            ...
                            layer.msg(msg.message, {time: 3000});
                            return false;
                        }
                    }
                });
...
<div class="footer">
    ...
    <div class="footer_icp warp">
        ...
        <p>
            ...
            <a href="${pageContext.request.contextPath}/picture/icp_img.jpg" target="_blank">杭ICP证140409号</a>　|　<a href="http://www.miitbeian.gov.cn/publish/query/indexFirst.action" target="_blank">杭ICP备17042235号</a>　|　机构信用代码证 91110107MA00EU339B
        </p>
        <p>
            ...
            <a href="http://www.bjp2p.com.cn/" target="_blank" title="北京市网贷行业协会发起会员"><img src="${pageContext.request.contextPath}/picture/footer_img1.jpg" /></a>
